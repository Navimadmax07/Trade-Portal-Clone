...
const BusinessDirectoriesCompany = () => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    // In real app, fetch companies for companyName here
        ...
        <div className="col-md-9 pt-3">
          <div className="card col-md-12 bg-light">
            <div className="card-heading p-3">
              <h4 className="text-center">Companies by Company Name</h4>
            </div>
...
export default BusinessDirectoriesCompany;
