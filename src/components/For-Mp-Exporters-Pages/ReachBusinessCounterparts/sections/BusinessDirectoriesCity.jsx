...
const BusinessDirectoriesCity = () => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    // In real app, fetch companies for cityName here
    // For demo, filter dummyCompanies
    if (!cityName.trim()) {
      setCompanies(dummyCompanies);
    } else {
      setCompanies(
        dummyCompanies.filter((c) =>
          c.city.toLowerCase().includes(cityName.trim().toLowerCase())
        )
      );
    }
  };
        ...
        <div className="col-md-9 pt-3">
          <div className="card col-md-12 bg-light">
            <div className="card-heading p-3">
              <h4 className="text-center">Companies by City</h4>
            </div>
...
export default BusinessDirectoriesCity;
